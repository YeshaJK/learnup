            ...
            <div class="col-12">
                <div class="card    ">
                    <div class="card-header bg-success">
                        <h3 class="text-white">Add Instructor</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form role="form" method="POST" action="{{route('instructor.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="phone_number" class="form-control" placeholder="Enter your Work Phone Number" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="date" id="date" maxlength="10" size="10"  placeholder="Enter your Birth Date" required>
                            </div>
                            <div class="form-group">
